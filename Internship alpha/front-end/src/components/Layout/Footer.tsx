      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900 dark:text-white">HeartGuard</span>
            </div>
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Providing cutting-edge heart disease prediction technology to help you stay ahead of health risks.
            </p>
          ...
          <div>
            <h3 className="text-base font-semibold text-gray-900 dark:text-white tracking-wider uppercase">Quick Links</h3>
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link to="/faq" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 text-sm">
                  FAQ
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="text-base font-semibold text-gray-900 dark:text-white tracking-wider uppercase">Resources</h3>
            <ul className="mt-4 space-y-3">
              <li>
                <Link to="/blog" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 text-sm">
                  Heart Health Guide
          ...
          <div>
            <h3 className="text-base font-semibold text-gray-900 dark:text-white tracking-wider uppercase">Contact Us</h3>
            <ul className="mt-4 space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="ml-3 text-gray-600 dark:text-gray-400 text-sm">+1 (800) 123-4567</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-primary-600 flex-shrink-0" />
                <span className="ml-3 text-gray-600 dark:text-gray-400 text-sm">contact@heartguard.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
            © {new Date().getFullYear()} HeartGuard. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
